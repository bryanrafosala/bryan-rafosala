const socialLinks = [
  {
    href: 'https://github.com/bryanrafosala',
  ...
  {
    href: 'https://www.linkedin.com/in/bryanrafosala',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.instagram.com/breiyaaan',
  ...
  return (
    ...
    >
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form
          action="https://getform.io/f/avregvja"
          method="POST"
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="bryanrafosala@example.com"
                className="text-field reveal-up"
              />
            </div>
          </div>
